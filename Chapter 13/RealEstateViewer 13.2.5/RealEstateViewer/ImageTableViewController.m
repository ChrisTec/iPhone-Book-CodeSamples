...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar {
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@real%%20estate%%20%@", api, [searchBar.text stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!image) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), imageLoadingBlock);
